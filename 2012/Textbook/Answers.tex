...
\item Graph
\item 240 watts/mph
\item \text{1,680} watts/mph, increasing faster
\item  \text{4,560} watts/mph, fastest yet
\end{enumerate}
...
$\approx$ \text{700,000} heartbeats/week \\ $\approx 37$ million heartbeats/year \\
(calculated  \text{705,600} and \text{36,792,000})
...
\item See below
\item proton
\item about \text{1,800} times heavier
...
\item Slope is \$\text{6,300}/month; it's how much money he earns in a month.\\  Intercept is -\$\text{82,500}; it's his start up costs.
...
\item % newspapers
\begin{enumerate}
\item \text{1,945} newspapers \\ \text{1,805} newspapers \\ \text{1,594} newspapers \\ \text{1,344} newspapers.
\item 1995-2010
\item Graph
\end{enumerate}
...
\item % Ayah's savings
\begin{enumerate}
\item  \$\text{41,883.82}, \$\text{48,610.75}, \$\text{37,051.28}
...
\begin{enumerate}
\item \$\text{1,024.74}/month
\item \$875.64/month
\item \$\text{1,370.20}/month
\end{enumerate}
...
\begin{enumerate}
\item $E=1.55L$
\item \$\text{10,667} locks
\item \$\text{7,200} locks
\end{enumerate}
...
\item \text{1,298} acres, \text{1,689} acres
...
Graph
\item Down slightly to \text{1,281} acres. \\ 
Up quite a bit to \text{1,776} acres
\end{enumerate}
...
\item $\approx$ \text{4,600} pounds, $\approx$ \text{6,200} pounds, $\approx$ \text{8,400} pounds
...
\item $V=$ value of Whitney's table (\$) $\sim$ dep \\ $A=$ age of table (years) $\sim$ indep \\ $V=560 \ast 1.065^A$ \\ $\approx$ \$\text{6,900}
\end{enumerate}
...
\item $\approx$ \text{1,960} calories, $\approx$ \text{1,780} calories, $\approx$ \text{1,600} calories
\item $\approx$ \text{1,962} calories, $\approx$ \text{1,782} calories, $\approx$ \text{1,618} calories
...
\begin{enumerate}
\item $H=17+\text{11,501}Y$ \\ $\approx$ \text{138,000} cars sold
