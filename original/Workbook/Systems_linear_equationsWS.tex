...
\begin{enumerate}
\item Madison wants to buy a new car, either Car A:  a hybrid priced at \$\text{26,100}, or Car B: a high-efficiency gas car priced at \$\text{23,700}.  Annual fuel costs for Car A are currently \$\text{1,100}.  For Car B annual fuel costs are currently \$\text{1,800}.  The total cost of each car will depend on how many years she keeps it. 
\begin{enumerate}
...
\input{Systems_linear_equations_end}
