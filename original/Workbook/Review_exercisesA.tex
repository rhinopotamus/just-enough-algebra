...
\item Brock is working as the equipment manager at a local gym.  They need to replace several weight machines.  One option will cost \$475 per month to rent the machines plus a delivery/removal fee of \$300.  The other option is to buy the machines for \$\text{23,600} and pay \$92/month for a service contract.
\begin{enumerate}
...
%
%
%\item At the time he graduated, Nic owed \$\text{26,700} in student loans at 5.75\% interest compounded monthly.  His monthly payment, \$$P$, depends on how long he has to pay back the loan, say $Y$ years according to the formula 
%$$P = \frac{\text{26,700}  \ast \frac{.0575}{12}}{1-\left( 1 + \frac{.0575}{12}\right) ^{-12Y}}$$
%
%\begin{enumerate}
...
\item  In 2000 there were an estimated \text{20,851,820} Texans.  The population of Texas has grown around 1.89\% per year since then.
...
\item The U.S.\ Census Bureau counted \text{25,145,561} Texans in 2010.  Does that mean the actual growth rate was slightly more or slightly less than 1.89\%?  Explain. \vfill
\end{enumerate}
...
\item In the United States in 1970, the average person ate \text{2,169} calories per day.  By 2008 that number had increased to \text{2,674} calories per day.  Let $C$ be the amount a typical person eats (in calories per day) and $Y$ the year, measured in years since 1970.  Compare what the linear and exponential models project for the years 2015 and 2030.  Include both equations and a graph showing both functions on the same axes.
