...
For example, suppose we read that the comprehensive fee at a local university is around \$\text{23,000} and projected to increase by 12\% per year.  We want to calculate the comprehensive fee in 4 years.  As we'll learn later in this course, the answer is 
$$\text{36,190.945}\ldots$$
The dots indicate that we have not copied all the digits from the calculator.
We could round to the nearest penny and say ``around \$\text{36,190.95}.''  Or, we could round to the nearest dollar and say ``around \$36,191.'' The numbers we are given (\$\text{23,000} and 12\%) have only two digits that matter, however, so we should actually round off and say ``just over \$\text{36,000}.'' 
