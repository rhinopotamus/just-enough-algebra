...
\item According to this equation, in what year is the number of annual visits the smallest?  In that year, what were the number of visits?  Show how to use the appropriate formula to calculate how low the number of annual visits were, according to the equation.  \emph{Be sure to show some work.}
...
\newpage
%%% Old 2.8, physics, fun
\item Joe swung at an inside pitch and connected with the baseball - it was headed out of the park!  The height $H$ feet of the baseball $T$ seconds after his swing is given by the equation $$H = 2+80T-16T^2$$
