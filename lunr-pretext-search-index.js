...
},
{
  ...
  "number": "5.2.8",
  "title": "",
  "body": " One modern technique for cleaning waste water involves the use of constructed (man-made) wetlands. Wetlands act as a natural biofilter for various contaminants in the waste water. After each month in the wetlands, only about of the contaminants remain in any given sample. Suppose a sample had 8 grams of contaminants before it was processed in the constructed wetlands.   (Story also appears in )    How much would remain in the sample after 1 month? 2 months? 3 months?   Name the variables and write an equation relating them.   Your equation should fit the template for an exponential equation. What is the monthly decay factor?   According to your equation, when will the contaminants fall below 1 mg? 1 g? Remember and .   Draw a graph illustrating the waste water treatment process for the first 6 months.  "
},
{
