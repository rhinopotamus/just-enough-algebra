...
},
{
  ...
  "number": "0.1.3",
  "title": "",
  "body": " Round off the calculated numbers to give an answer that is reasonable and no more precise than the information given.   The snow removal budget for the city is currently at $8.3 million but the city council is requesting a reduction of $1.15 million per year. We calculate that after three years of cuts, the snow removal budget will be $4.8079... million.   A cup of cooked red lentils has around 190 calories and 6.4 grams of dietary fiber, while a cup of cooked chickpeas has around 172 calories and 12.0 grams of dietary fiber. We calculate that lentils provide 0.03368421... grams per calorie whereas chickpeas provide 0.06976744... grams per calorie.    Hibbing [Minnesota] is the former boyhood home of Bob Dylan, basketball great Kevin McHale and the location of the Hull-Rust-Mahoning Open Pit Iron Mine, which has the largest iron-ore pit in the world. Hibbing is also the birthplace of [baseball star] Roger Maris.    In 2000 the population of Hibbing, Minnesota was reported at just over 17,000 residents. Based on a projected 0.4% decrease per year, the 2010 population was calculated to be 16,332.110... people.  "
},
{
...
},
{
  ...
  "number": "0.6.2",
  "title": "",
  "body": " The size of a round pizza is described by its diameter. It turns out that we can calculate how many people are served by a pizza of diameter inches as . For example, a 16-inch diameter pizza serves people. (The mysterious number 0.015625 comes from a little geometry and pizza science.)   (Story also appears in 2.4 #1, 3.3 #1, and 4.1 #3)    How many people would be served by a 12-inch pizza?   A personal pizza is designed to serve one person. It turns out the diameter of a personal pizza is . Calculate the diameter of a personal pizza using the square root key (or just the root key) on your calculator.   An extra large pizza serves 6 people. It turns out the diameter of an extra large pizza is . Calculate the diameter of a personal pizza using the square root key (or just the root key) on your calculator.  "
},
{
...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": " Rent in the Riverside Neighborhood is expected to increase 7.2% each year. Average rent for an apartment is currently $830 per month. (Story also appears in 3.4 #3)    Identify and name the variables, including the units.   Explain the dependence using a sentence of the form is a function of .   Which number is a constant in this story: the percent increase (7.2) or the apartment rent (830)?   What is a realistic domain for this function? That means, for how many years might this sort of increase in rent continue? Express your answer as an inequality.   What is the average rent expected to be in 1 year? In 2 years? In 3 years? Note that . Try figuring it out.  "
},
{
...
},
{
  ...
  "number": "1.2.4",
  "title": "",
  "body": " A mug of coffee costs $3.45 at Juan's favorite cafe. (Story also appears in 2.1 #4 and 4.2 #2)    Juan buys coffee on the way to work every day. How much does Juan spend on coffee in a month? Let's say that's 22 workdays.   If Juan pays $10 for a discount card, then coffee costs $2.90\/mug instead. How much (total) would Juan spend on coffee in a month if he buys the discount card first? Still use 22 workdays. Include the $10.   Does the card pay for itself within the month? That means, is the total with the card (including the $10 for the card) less than the total without the card?   Complete the table, where is the number of mugs of coffee Juan buys and is the total cost, in dollars.     0  10  22  50    (regular)        (with card)         Draw a graph illustrating both functions.     What does the point where the two lines cross mean in terms of the story?  "
},
{
...
},
{
  ...
  "number": "1.5.2",
  "title": "",
  "body": " Edgar recently changed the cleaning bag on his vacuum cleaner. He became curious about how many particles of dust were in the bag. Edgar did a little research online and found out that the mass of a dust particle is .000 000 000 753 kilograms.  (The strange-looking spaces are to help you see that there are 9 zeros in the number.)   Write the mass of a dust particle in scientific notation.   Recall that    kilo   1 thousand        milli   1 in a thousand   .001      micro   1 in a million   .000001      nano   1 in a billion   .000 000 001      Express the mass of a dust particle in each of the given units:   grams   milligrams (mg)   micrograms ( g)   nanograms (ng)   Edgar determined that the full vacuum bag weighed 5 pounds. How many dust particles were in the bag? (I am already sneezing.) Use . Express your answer in scientific notation.  "
},
{
  ...
  "number": "1.5.3",
  "title": "",
  "body": " The list shows the (approximate) mass of the planets in our solar system.     Earth  kg    Jupiter  kg    Mars  kg    Mercury  kg    Neptune  kg    Saturn  kg    Uranus  kg    Venus  kg     Write the mass of Earth and the mass of Mars in standard decimal notation. Which is heavier?   List the planets from heaviest (largest mass) to lightest (smallest mass).   The mass of astronomical bodies are sometimes measured in Jupiter mass , abbreviated , where kg. Express Earth's mass in .   Because and are at the same level in the order of operations, you need to put parentheses around each number in scientific notation before dividing.   "
},
{
...
},
{
  ...
  "number": "2.6.1",
  "title": "",
  "body": " United States ethanol production has been growing exponentially. In 1990, there were 0.9 billion gallons of ethanol produced. At that time it was estimated that production would increase 5.5% per year.    Name the variables, including units.   What is the annual growth factor?   Write an equation that describes the function.   In 2008 actual production of ethanol was 9.0 billion gallons. Is that production level higher or lower than predicted from your equation? Explain.   When does your equation predict that ethanol production was 9.0 billion gallons? Use successive approximation. Display your guesses in a table. Report the actual year.  "
},
{
...
},
{
  ...
  "number": "3.7.1",
  "title": "",
  "body": "  Goldie the Goldfish, Pinches the Lobster, Quackers the Duck, Speedy the Turtle. These first generation Beanie Babies toys were anticipated to increase in value according to the equation where is the value of Beanie Babies (in $) and is the time in years since 1994.   Make a table showing the anticipated value in 1994, 2004, 2010, and 2025.   Draw a graph showing how the value of the Beanie Babies increased.     The problem continues ...   Set up and solve an equation to determine when will Beanie Babies made in 1994 were anticipated to be worth over $40. Report the actual year.  "
},
{
...
},
{
  ...
  "number": "4.1.1",
  "title": "",
  "body": " A solar heating system costs approximately $30,000 to install and $150 per year to run. By comparison, a gas heating system costs approximately $12,000 to install and $700 per year to run. (Story also appears in 4.2 Exercises)     What is the total cost for installing and running a gas heating system for 30 years?   Name variables and write a linear equation showing how the total cost for a gas heating system depends on the number of years you run it.   Name variables and write a linear equation showing how the total cost for a solar heating system depends on the number of years you run it.   If you install and run a solar heating system, how many years can you use it before it costs the same as installing and running a gas heating system for 30 years (your answer to part (a))? Set up and solve an equation.  "
},
{
...
},
{
  ...
  "number": "5.2.1",
  "title": "",
  "body": " A signal is sent down a fiber optic cable. Its strength decreases by 2% each mile it travels. (Say it was one unit strong to start.) Story also appears ....    Name the variables, including units.   Make a table showing the strength of the signal over the first five miles.   Write an equation relating the variables.   The signal will need a booster (something to make the signal stronger again) when it has fallen to under 0.75 units. How far along the cable should the booster be placed? Set up and solve an equation.    The problem continues ...   What is the half-life (or should we say half-distance) of a signal? That means, how far can it travel without dropping below 50%? (That will not actually happen because we would boost the signal.) Again, set up and solve an equation.   Draw a graph illustrating the relationship.    Indicate the points on your graph where you can check your answers to parts (c) and (d).  "
},
{
...
},
{
  ...
  "number": "6.1.8",
  "title": "",
  "body": " In 2000 there were an estimated 20,851,820 Texans. The population of Texas has grown around 1.89% per year since then.    Name the variables and write an equation relating them.   According to your equation, what was the population of Texas in 2010?   The U.S. Census Bureau counted 25,145,561 Texans in 2010. Does that mean the actual growth rate was slightly more or slightly less than 1.89%? Explain.  "
},
{
  "id": "curl-weight-PE6A",
  "level": "2",
