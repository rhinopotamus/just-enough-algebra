...
\item The profit  \$$P$ of selling $N$ t-shirts is given by the equation $$P = 5.45N-350$$  How many t-shirts do they need to sell to break even ($P=0$)? To make \$\text{1,000} profit?
\item Is one of your answers to (a) the same as one of your answers to (b)?  They should be.  Explain why.
\end{enumerate}


 \item (2.5)   \begin{enumerate} 
\item Cicely wants to buy a new car that costs \$\text{19,400}.  The dealership offers 5.58\% compounded monthly for a 5 year loan.  What will Cicely's monthly payment be? Use the \textsc{Loan Payment Formula}.  
...
\item In 2011, Cicely was cleaning out the basement and found some savings bonds with face value \$\text{1,600} that matured in 1972 and have been earning 3\% interest compounded monthly ever since.  What were they worth? Use the \textsc{Compound Interest Formula}.  
\end{enumerate}
 
 \item  (2.5)  \begin{enumerate} 
\item Kotoyo's uncle won \$\text{100,000} on a game show.  If he invests it in a fund that's expected to earn 5.7\% interest compounded monthly, how much will he have after 5 years? Use the \textsc{Compound Interest Formula}. 
...
\item Kotoyo owes \$\text{8,742} on her credit card.  They charge her 16\% interest compounded monthly.  What would her monthly payment be if she wants to pay it off in 5 years? Use the \textsc{Loan Payment Formula}.  
